...
fluidPage(
    ...
    tabsetPanel(
        ...
        tabPanel("Lineage Size Distribution",
                 ...
                 fluidRow(column(width=6,
                                 selectInput("stochastic_lsd_normlibsize", label="library size normalization",
                                             selected="scale",
                                             choices=c(`none`="none", `scale read counts`="scale", `subsample reads`="subsample")),
                 ...
                 bs_collapse("simulation_settings",
                             fluidRow(column(width=2,
                                      ...
                                      column(width=2,
                                             ...
                                             checkboxInput("pcr_coarse", "Coarser & faster PCR model (Gamma approximation)", width="100%", value=TRUE)),
                                      column(width=2,
                                      ...
                                      column(width=2,
                                             numericInput("lineage_aliases", "Aliases per lineage", width="100%",
                                                          min=1, max=Inf, value=NA_real_, step=1),
