...
// san_timediscrete_c
List san_timediscrete_c(List C_init, NumericVector p_S, NumericVector p_0, NumericVector p_R, NumericVector p_A, NumericVector p_N, NumericVector p_D, IntegerVector steps);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< List >::type C_init(C_initSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type p_S(p_SSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type p_0(p_0SEXP);
